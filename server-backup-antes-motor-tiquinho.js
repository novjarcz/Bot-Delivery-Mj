...
async function processarMensagem(
  ...
  // ===================================================
  // PRODUTOS DETECTADOS NO CARDÁPIO
  // ===================================================
    ...
    const contextoCardapio =
      produtosDetectados
        ...
        .map((produto) => ({
          ...
          correspondencias:
            produto.correspondencias,
        }));

    mensagemParaIA =
      `[PRODUTOS ENCONTRADOS NO CARDÁPIO OFICIAL]\n` +
      `${JSON.stringify(contextoCardapio, null, 2)}\n\n` +
